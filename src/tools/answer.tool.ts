...
export const answerTool: Tool = {
  name: 'answer',
  description:
    'Answer questions and provide up-to-date information using web search. Called after PLAN has identified an answer request and user has confirmed. Searches the web for current data and provides concise, helpful responses formatted for terminal display.',
  input_schema: {
    type: 'object',
    properties: {
      question: {
